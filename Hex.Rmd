...
Read in a shapefile with the `read_polygons` function from `geogrid` and plot it.
...
#Generate new grid
by testing different seed numbers we can generate a range of hexagon layouts - we can then select a version for use inthe final map.

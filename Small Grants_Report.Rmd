...
sg_sport %>%
  ...
  theme(text = element_text(family = "Poppins", size = 12, color = "#525252"),
        ...
        plot.caption=element_text(size=9, hjust=0, margin=margin(15,0,0,0)),
        legend.position = "left") +
  labs( x= "Organisation type", y = "Number of Awards", title = "Type of Sport by \nAward Amount") +
  scale_y_continuous(labels = scales::dollar_format(prefix = "£"))
```
...
The below table shows the proportion the Small Grants fund invests per outcome. NB a minority of awards are duplicated - this is because a few contribute to more than one outcome. 
...
The below table and chart show the amount the Small Grants fund invests per outcome. 
...
ggplot(me_box_g)+
  ...
  theme(text = element_text(family = "Poppins", size = 12, color = "#5F5F5F"),
        ...
        plot.caption=element_text(size=9, hjust=0, margin=margin(15,0,0,0)),
        legend.position = "left")  +
  labs( x= "Gender focus", y = "Amount awarded", title = "Amount Awarded by Gender: \nSuccess of Project", caption = "'Successful' is defined as projects that \nmeet or exceed the year 1 target") +
  scale_y_continuous(labels = scales::dollar_format(prefix = "£")) +
  scale_fill_manual(values = se_colour, name = "Is the project \nsuccessful?")

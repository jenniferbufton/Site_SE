...
DT::datatable(table_df,  filter = 'top',
  ...
  formatRound(9,0) %>%
formatStyle(columns = "URN", font = "Poppins", color = "#B8345C" , backgroundColor = "#E79AB5" )
...
ggplot(sg_df)+
  geom_histogram(aes(IMD_Decile_2019), fill = "#ff6105", binwidth = 1 )+
  theme(text = element_text(family = "Poppins", size = 12, color = "#5F5F5F"),
        plot.title=element_text(size=14,family = "Poppins", face="bold", hjust = 0.5, color = "#525252"),
        axis.text.x = element_text(angle = 45, hjust = 1),
        panel.grid = element_blank(),
...
formatStyle(columns = "GMS_URN", font = "Poppins", color = "#B8345C" , backgroundColor = "#E79AB5" )

...
```{r org_amount, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
  ...
  theme(text = element_text(family = "Norwester", size = 12, color = "#525252"),
        ...
        plot.caption=element_text(size=9, hjust=0, margin=margin(15,0,0,0)),
        legend.position = "right") +
  labs( x= "Organisation type", y = "Award amount", title = "Organisation Type by Award Amount")+
  scale_y_continuous(labels = scales::dollar_format(prefix = "£"))
...
# Measure and Evaluation {.tabset .tabset-fade .tabset-pills} 
...
me_df <- me_df %>%
  select("GMS_URN", "Sport", "Org_Class", "AWARD", "PARTICIPANTS BASELINE", "PARTICIPANTS PROJECT OVERALL" , "YEAR 1 PARTICIPANTS TARGET", "12 MONTH PARTICIPANTS", "prediction") %>%
...
<br>
The below boxplot shows the distribution of award amounts by whether the project was successful or not. The main difference is a greater range of award amount for those projects that "failed".
```{r succes_box, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
ggplot(me_df)+

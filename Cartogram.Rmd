...
Here, we are going to read in some already-existing spatial data and a variable from the Active Lives survey to map.
```{r test_map, echo=FALSE, message=FALSE, warning=FALSE}

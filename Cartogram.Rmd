...
Here, we are going to read in spatial data slightly differently to the shapefile tutorial to demonstrate an alternative way, which enables us to do a quick plot. This approach uses the `readOGR` function from the `rgdal` package, and a variable from the Active Lives survey to map.
